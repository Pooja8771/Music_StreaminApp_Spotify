...
export default function Body({headerBackground}) {
  ...
  useEffect(() => {
    const getInitialPlaylist = async () => {
      ...
      dispatch({ type: reducerCases.SET_PLAYLIST, selectedPlaylist: updatedSelectedPlaylist });
    };
